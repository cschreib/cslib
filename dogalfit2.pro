...
pro dogalfit2, filename, imgsize, output=output, error=error, psf=psf, badpix=badpix, aspix=aspix, $
    ...
    if ~provided(galfit) then galfit = 'galfit2'
    ...
    printf, 1, '8) '+ratio1+' '+strn(tfreeratio[0])      ; Axis ratio
    printf, 1, '9) '+angle1+' '+strn(tfreeangle[0])      ; Angle
    printf, 1, '10) 0.0 0'                               ; Boxiness
    printf, 1, 'Z) 0'                                    ; Option
    ...
    printf, 1, '8) '+ratio2+' '+strn(tfreeratio[1])      ; Axis ratio
    printf, 1, '9) '+angle2+' '+strn(tfreeangle[1])      ; Angle
    printf, 1, '10) 0.0 0'                               ; Boxiness
    printf, 1, 'Z) 0'                                    ; Option
    endif
